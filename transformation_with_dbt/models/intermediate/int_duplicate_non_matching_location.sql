...
combined_addresses AS (
    ...
    FROM deduplicated_addresses da
    LEFT OUTER JOIN matching_addresses ma ON da.location_postal_code = ma.location_postal_code
    LEFT OUTER JOIN nonmatching_addresses na ON da.location_postal_code = na.location_postal_code
),
final_addresses AS (
    SELECT
        location_postal_code,
